...
Vagrant.configure(2) do |config|
  ...
  config.vm.define "zuul" do |zuul|
    zuul.vm.box = "ubuntu/trusty64"
    zuul.vm.hostname = "zuul"

    zuul.vm.network :private_network, ip: "192.168.202.213"

    zuul.vm.provider "virtualbox" do |vb|
      vb.memory = "512"
    end
  end
end
